...
import { isPlatformDarwin, isPlatformLinux, isPlatformWindows, resolveCliPathFromVSCodeExecutablePath } from './util.js';
const platforms = [
    'darwin',
    'darwin-arm64',
    'win32-x64-archive',
...
describe('sane downloads', () => {
    ...
    const isRunnableOnThisPlatform = process.platform === 'win32'
        ? isPlatformWindows
